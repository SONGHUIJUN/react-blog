      ...
      <div>
        {
          ...
          <div className="article-item" onClick={() => this.showArticleDetail(articleData)}>
        ...
        }
        {
          ...
          <div className="article-item article-item-type-right" onClick={() => this.showArticleDetail(articleData)}>
            <div className="article-item-left">
              ...
              <div className="article-item-container">
                ...
                <span className="article-item-close"
                      onClick={(e) => this.closeArticle(e, articleData)}><CloseOutlined/></span>
              </div>
            </div>
